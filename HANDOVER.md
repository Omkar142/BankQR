...
UPI intent support is deployed: an optional merchant VPA creates a strict V2 fragment and an exact `upi://pay` action while V1 links and manual account/IFSC transfer remain supported. Unit, emulated-browser and public Pages browser gates pass. Validate the operating-system chooser on a physical Android phone before calling the UPI flow field-verified.
