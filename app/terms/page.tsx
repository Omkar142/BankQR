  ...
  return (
    <AppShell>
      <main id="main" className="legal-container">
        ...
        <p>
          BankQR may open a compatible UPI app with prefilled payment
          instructions. It does not authorise, hold, process, clear, settle,
          verify or confirm payments. It does not enforce payment limits or
          determine fees. UPI and NEFT/IMPS availability, beneficiary setup,
          processing times and limits are determined by the selected provider.
        </p>
        <h2>Bank apps and confirmation</h2>
        <p>
          Bank names in the guidance sheet do not imply integration,
          partnership or endorsement. A compatible-app prompt is generated by
          your operating system, not an endorsement by BankQR. Check the payee,
          amount and payment status with your provider and recipient; copying
          details or opening an app is not payment confirmation.
        </p>
